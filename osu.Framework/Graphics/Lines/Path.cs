...
namespace osu.Framework.Graphics.Lines
{
    public partial class Path : Drawable, IBufferedDrawable
    {
        ...
        protected override DrawNode CreateDrawNode() => new PathBufferedDrawNode(this, (this as DoomPath)?.DoomMode == true ? new PathDrawNodeDoom(this) : new PathDrawNode(this), sharedData);
